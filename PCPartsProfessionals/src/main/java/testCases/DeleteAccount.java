...
public class DeleteAccount {
  ...
  public void testDeleteAccount() throws Exception {
    ...
    driver.findElement(By.id("username")).sendKeys("DeleteAccountTest");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("Delete");
    driver.findElement(By.id("email")).click();
    driver.findElement(By.id("email")).clear();
    driver.findElement(By.id("email")).sendKeys("Delete@gmail.com");
    driver.findElement(By.id("phonenumber")).click();
    driver.findElement(By.id("phonenumber")).clear();
    driver.findElement(By.id("phonenumber")).sendKeys("098-098-0987");
